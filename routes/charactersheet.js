...
router.post('/', function(req, res) {
    ...
    Character.create(req.user.id, req.body.characterName, req.body.characterClass, req.body.characterLevel, req.body.characterBackground, req.body.characterRace.race, req.body.charAlign.alignment, req.body.characterExp, req.body.characterStr,

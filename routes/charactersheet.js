...
router.post('/', function(req, res) {
    ...
    Character.create(req.body.characterName, req.body.characterClass, req.body.characterLevel, req.body.characterBackground, req.body.characterRace, req.body.charAlign, req.body.characterExp, req.body.characterStr,
